      ...
      <section className="relative overflow-hidden min-h-[650px] flex items-center pt-16 geometric-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-center pt-64 md:pt-80 bg-gray-900/60 p-8 rounded-xl flex flex-col items-center justify-center">
              ...
              <motion.p
                ...
                className="text-xl text-white mb-10 max-w-xl mx-auto"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center pb-8">
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12 opacity-70">
              ...
              <img src="https://raw.githubusercontent.com/microsoft/PowerBI-Icons/main/SVG/Power-BI.svg" alt="Power BI" className="h-6" />
              ...
              <img src="https://www.svgrepo.com/show/331760/sql-database-generic.svg" alt="SQL" className="h-6" />
