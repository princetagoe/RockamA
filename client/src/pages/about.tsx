          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            >
              ...
              <div className="mb-10 p-6 bg-gray-50 rounded-xl border border-gray-100">
                <h3 className="text-2xl font-semibold text-gray-800 mb-6 text-center border-b pb-2 border-gray-200">
                  Our Foundation
                </h3>
                
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-white p-5 rounded-lg shadow-sm">
                    <h4 className="text-xl font-medium text-primary mb-3 text-center">Our Mission</h4>
                  ...
                  <div className="bg-white p-5 rounded-lg shadow-sm">
                    <h4 className="text-xl font-medium text-primary mb-3 text-center">Our Purpose</h4>
                    <p className="text-gray-600">
                  ...
                  <div className="bg-white p-5 rounded-lg shadow-sm">
                    <h4 className="text-xl font-medium text-primary mb-3 text-center">Our Values</h4>
                    <p className="text-gray-600">
                      To fulfill our purpose and achieve our mission, we live by these essential values:
                      <span className="font-medium block mt-2">Excellence, Customer-Focus, Agility, and Accountability</span>
                    </p>
                  </div>
                </div>
